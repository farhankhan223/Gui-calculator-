...
def get_result():
    ...
    if operator=="+":
        ...
        else:result_label.config(text=str(first_number/second_number))
...
btnmult=Button(root,text='*',bg="#00a65a",fg='white',width=5,height=2,command=lambda:get_operator('*'))
btnmult.grid(row=3,column=3)
btnmult.config(font=('verdana',14))
